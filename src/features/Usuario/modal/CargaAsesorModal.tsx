...
import { cargaAsesorUsuario } from "../services/serviceUsuario";

export const CargarAsesorModal = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await cargaAsesorUsuario(formData);
