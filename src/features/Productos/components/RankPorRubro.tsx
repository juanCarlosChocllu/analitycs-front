  ...
  return (
    <Box>
      {data.map((rubro, index) => {
        ...
        const nuevaData = rubro.producto.sort(
              ...
              <Table size="small" aria-label={`Tabla de ${rubro.rubro}`}>
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell align="right">  {porcentaje2(
                            totalVenta,
                            totalVenta
                          ).toFixed(2)}{" "}
                          %</TableCell>
                    <TableCell align="right">100.00%</TableCell>
                    <TableCell align="right">{ (totalVenta / dias).toFixed(2)}</TableCell>
                    <TableCell align="right"> {(
                            totalStockSucursal /
                            (totalVenta / dias)
                          ).toFixed(2)}</TableCell>
                    <TableCell align="right">{(totalVenta / totalStockSucursal * 100).toFixed(2)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
