...
export const TablaMeta: React.FC<TablaMetaProps> = ({ filtro, isRefresh }) => {
  ...
  const fetchMetas = useCallback(async () => {
    try {
      ...
      const response = await listarMetasScursales(filtro, rowsPerPage, currentPage + 1);
  ...
  const fakeTotal = totalPages * rowsPerPage;
      ...
      <Paper sx={{ width: "100%", overflow: "hidden" }}>
        <TableContainer>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell align="center">{createSortLabel("sucursal", "Sucursal")}</TableCell>
                <TableCell align="center">{createSortLabel("ticket", "Ticket")}</TableCell>
                <TableCell align="center">{createSortLabel("monto", "Monto")}</TableCell>
                <TableCell align="center">{createSortLabel("dias", "Días Comerciales")}</TableCell>
                <TableCell align="center">{createSortLabel("fechaInicio", "Fecha Inicio")}</TableCell>
                <TableCell align="center">{createSortLabel("fechaFin", "Fecha Fin")}</TableCell>
                <TableCell align="center">{createSortLabel("fecha", "Fecha Creación")}</TableCell>
        ...
        {/* ✅ Paginación correcta con índices base 0 */}
        <TablePagination
