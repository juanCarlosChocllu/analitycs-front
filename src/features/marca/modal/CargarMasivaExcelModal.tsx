...
import { cargaMasivaCategoria } from "../service/marcarService";
import toast, { Toaster } from "react-hot-toast";
import type { AxiosError } from "axios";

export const CargarMasivaExcelModal = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await cargaMasivaCategoria(formData);
      ...
      toast.error("ocurrio un erro", e.response?.data.message);
    }
  };
